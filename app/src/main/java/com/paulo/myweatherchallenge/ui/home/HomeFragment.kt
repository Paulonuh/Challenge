...
import com.paulo.myweatherchallenge.extensions.showToast
...
//        }
        ...
        binding.mlHome.addTransitionListener(object : MotionLayout.TransitionListener {
            override fun onTransitionStarted(motionLayout: MotionLayout?, startId: Int, endId: Int) {
                //viewModel.ldWeatherLocation.value?.name?.let { binding.toolbarHome.updateTitle(it) }
            }
            ...
            override fun onTransitionCompleted(motionLayout: MotionLayout?, currentId: Int) {
                if (motionLayout?.progress == 0.0f) {
                    binding.toolbarHome.updateTitle(R.string.app_name)
